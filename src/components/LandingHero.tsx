  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[1] flex items-center justify-center">
        <div
          className={`absolute h-[100vh] w-[100vw] opacity-90 transition-opacity duration-1000 ${
          ...
          >
            <Suspense fallback={null}>
              <OrbComponentlazy
                ...
                grainSize={0.0115 + audioActivityLevel * 0.01} // Adjusted grain size for better visuals
                vertexColors={false}
      ...
      <AnimatePresence mode="wait">
        {!voiceChatActive && (
          <motion.div
            className="absolute bottom-0 left-0 right-0 z-[10] flex w-full items-end justify-center pb-8 md:pb-12"
              ...
              <div className="mx-auto max-w-3xl text-center">
                ...
                <div className="flex flex-col justify-center gap-4 sm:flex-row">
                  ...
                  <motion.button
                    ...
                    className="flex w-full items-center justify-center gap-3 px-7 py-3.5 text-sm font-semibold sm:w-auto"
                    style={{
                      clipPath:
                        "polygon(0 0, calc(100% - 12px) 0, 100% 12px, 100% 100%, 12px 100%, 0 calc(100% - 12px))",
                      border: isDark
                ...
                >
                  <div className="flex items-center gap-2">
                    <div
                      className={`flex h-8 w-8 items-center justify-center rounded-full ${styles.featureIconBackground}`}
                    >
                      <MessageSquare
                        size={14}
      ...
      <AnimatePresence>
        {voiceChatActive && (
          <motion.div
            className="relative z-[10] h-full w-full pt-24"
          ...
          >
            ...
            <div className="flex h-full w-full items-center justify-center px-4 pt-16">
